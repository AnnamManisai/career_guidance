<?php
// https://www.tutorialrepublic.com/php-tutorial/php-mysql-login-system.php  this website helped me in creating this login page :)
session_start();
...
// without this there is no login page :(...:)
require_once "config.php";
 
// just defining variables later user can give credentials that's me :)
$username = $password = "";
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="main.php" style="padding-bottom: 10px;">mini project</a>
					</div>
					<!-- /Logo -->
